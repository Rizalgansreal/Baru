...
color_table = "#FFFFFF"
color_rich = "[#00C8FF]"
sys.stdout.write('\x1b]2; Kang-Cabul\x07')
...
# USN=""Mozilla/5.0 (Linux; Android 12; SM-G991B Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36 Instagram 264.0.0.22.106 Android (29/10; 320dpi; 720x1456; OPPO; CPH2185; OP4F2F; mt6765; it_IT; 430370701)
...
class instagram:
	...
	def methodku(self):
		urut = []
		urut.append(Panel(f"B API {H2}{P2}",title=f"{R2}01{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		urut.append(Panel(f"B PAJAK{H2}{P2}",title=f"{R2}02{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		urut.append(Panel(f"B API NERAKA V2{H2}",title=f"{R2}03{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
		urut.append(Panel(f"B AIR{H2}",title=f"{R2}04{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
		self.tol.print(Columns(urut))
